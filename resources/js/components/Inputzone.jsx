    ...
    return (
        <div className="Inputzone">
            <div className="Inputzone__field">
                ...
                <button disabled={characterName === ''} className="Inputzone__submit" onClick={createCharacter} type="submit">Enregistrer</button>
            </div>
            <div className="Inputzone__field">
                <span className="Inputzone__label">
                    Produit
                ...
                <button disabled={product === ''} className="Inputzone__submit" onClick={createProduct} type="submit">Enregistrer</button>
            </div>
        </div>
    );
